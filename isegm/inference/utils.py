...
from isegm.data.datasets import GrabCutDataset, BerkeleyDataset, DavisDataset, \
    SBDEvaluationDataset, PascalVocDataset, BraTSDataset, ssTEMDataset, OAIZIBDataset, HARDDataset, COCOMValDataset
...
def get_dataset(dataset_name, cfg):
    ...
    elif dataset_name == 'COCO_MVal(seen)':
        dataset = COCOMValDataset(cfg.COCO_MVAL_PATH,category='seen')
    elif dataset_name == 'COCO_MVal(unseen)':
        dataset = COCOMValDataset(cfg.COCO_MVAL_PATH,category='unseen')
