...
def init_model(cfg):
    ...
    # model._load_pretrained_model(cfg.IMAGENET_PRETRAINED_MODELS.SBD_VIT_BASE)
    model.to(cfg.device)
...
def train(model, cfg, model_cfg):
    ...
    loss_cfg.mid_loss = NormalizedFocalLossSigmoid(alpha=0.5, gamma=2)
    loss_cfg.mid_loss_weight = 1.0
